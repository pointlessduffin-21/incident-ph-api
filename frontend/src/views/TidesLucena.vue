<template>
  <div class="min-h-screen bg-gradient-to-br from-teal-50 via-green-50 to-emerald-50">
    <!-- Header -->
    <header class="bg-white shadow-sm border-b border-teal-100">
      <div class="container mx-auto px-4 py-4">
        <div class="flex items-center justify-between">
          <div class="flex items-center space-x-4">
            <RouterLink to="/tides" class="text-teal-600 hover:text-teal-800 transition">
              <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18" />
              </svg>
            </RouterLink>
            <div>
              <h1 class="text-2xl font-bold text-gray-900">🌊 Lucena City Tide Forecast</h1>
              <p class="text-sm text-gray-600">Tayabas Bay, Quezon Province</p>
            </div>
          </div>
          <button 
            @click="refreshData"
            :disabled="loading"
            class="px-4 py-2 bg-teal-600 text-white rounded-lg hover:bg-teal-700 transition disabled:opacity-50 disabled:cursor-not-allowed flex items-center space-x-2"
          >
    ...
    <nav class="bg-white shadow-sm border-b border-gray-200">
      <div class="container mx-auto px-4">
        <div class="flex space-x-8">
          ...
          <RouterLink
            to="/tides/lucena"
            class="border-b-2 border-teal-600 py-4 px-1 text-sm font-medium text-teal-600"
          >
            Lucena City
          </RouterLink>
          <RouterLink
    ...
    <main class="container mx-auto px-4 py-8">
      ...
      <div v-else-if="tideForecast" class="space-y-6">
        <!-- Location Info Card -->
        <div class="bg-gradient-to-r from-teal-600 to-green-600 rounded-xl shadow-lg p-6 text-white">
          <div class="flex items-center justify-between">
            <div>
            ...
            <div class="text-right">
              <div class="text-sm text-teal-100 mb-1">Next Tide</div>
          ...
          <div class="bg-white rounded-xl shadow-lg p-6">
            ...
            <div v-else class="space-y-3">
              <div
                ...
                :class="tide.type === 'High Tide' ? 'border-teal-300 bg-teal-50' : 'border-orange-300 bg-orange-50'"
              >
                <div class="flex items-center justify-between p-4">
                  <div class="flex items-center space-x-4">
                    ...
                    <div>
                      <div class="text-lg font-bold" :class="tide.type === 'High Tide' ? 'text-teal-900' : 'text-orange-900'">
                        {{ tide.type }}
                      </div>
                  ...
                  <div class="text-right">
                    <div class="text-3xl font-bold" :class="tide.type === 'High Tide' ? 'text-teal-700' : 'text-orange-700'">
        ...
        <div v-if="tideForecast.nextDays.length > 0" class="bg-white rounded-xl shadow-lg p-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div
              ...
              :key="index"
              class="border border-gray-200 rounded-lg p-4 hover:border-teal-300 hover:shadow-md transition"
            >
              ...
              <div class="space-y-2">
                ...
                >
                  ...
                  <div class="text-right">
                    <div class="font-bold" :class="tide.type === 'High Tide' ? 'text-teal-700' : 'text-orange-700'">
                      {{ tide.heightMeters.toFixed(2) }}m
                    </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          <!-- Tide Chart Info -->
          <div class="bg-gradient-to-br from-teal-50 to-teal-100 border-l-4 border-teal-500 rounded-lg p-6">
            <div class="flex items-start">
              <svg class="w-6 h-6 text-teal-600 mr-3 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
              <div>
                <h4 class="font-bold text-teal-900 mb-2">Understanding Tides</h4>
            ...
            <div class="flex items-start">
              ...
              <div>
                ...
                >
                  ...
                  <strong>Location:</strong> Tayabas Bay ({{ tideForecast.latitude.toFixed(4) }}°N, {{ tideForecast.longitude.toFixed(4) }}°E)<br>
...
async function refreshData() {
  ...
  try {
    console.log('🌊 Fetching Lucena tide data...');
    const data = await tideService.getLucenaTideForecast();
    if (data) {
